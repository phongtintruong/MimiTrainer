...
class MimiSplitResidualVectorQuantizer(nn.Module):
    ...
    def decode(self, codes: torch.Tensor) -> torch.Tensor:
        ...
        return quantized_out, semantic_token
...
class MimiModel(MimiPreTrainedModel):
    ...
    def _decode_frame(
        ...
        embeddings, semantic_token = self.quantizer.decode(codes)
    ...
    def decode(
        ...
        return MimiDecoderOutput(audio_values, semantic_token, decoder_past_key_values)
