...
setup(
    ...
    install_requires=['numpy', 'torch', 'torchaudio', 'einops', 'scipy', 'huggingface-hub', 'soundfile', 'matplotlib', 'lion_pytorch', 'accelerate', 'transformers', 'datasets', 'huggingface_hub', 'python-dotenv', 'beartype', 'librosa'],
